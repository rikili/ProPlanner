            ...
            <Navbar className="navigation-bar" collapseOnSelect expand="lg">
                <Container className="nav-container">
                    <Link to={`/${planId}`} className="navlink">
                        <Navbar.Brand as="h4" bsPrefix="nav-brand">
                            ProPlanner
                        </Navbar.Brand>
                    </Link>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav" className="navbar-collapse">
                        ...
                        <div className="user-link-group">
                            <OverlayTrigger placement="bottom" overlay={renderTooltip('Copy Code')}>
                                <button
                                    className="nav-link"
                                    onClick={() => {
                                        setCopied(true);
                            ...
                            <NavDropdown
                                ...
                                <NavDropdown.Item onClick={handleEdit}>Edit plan</NavDropdown.Item>
                                <NavDropdown.Divider />
